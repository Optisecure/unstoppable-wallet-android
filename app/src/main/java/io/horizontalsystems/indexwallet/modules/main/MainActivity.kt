...
import io.horizontalsystems.indexwallet.modules.rateapp.RateAppDialogFragment
import io.horizontalsystems.indexwallet.modules.send.SendActivity
import io.horizontalsystems.indexwallet.modules.transactions.transactionInfo.TransactionInfoView
import io.horizontalsystems.indexwallet.modules.transactions.transactionInfo.TransactionInfoViewModel
...
class MainActivity : BaseActivity(), TransactionInfoView.Listener, RateAppDialogFragment.Listener {
    ...
    private fun openAppInPlayStore() {
        val uri = Uri.parse("market://details?id=io.horizontalsystems.indexwallet")  //context.packageName
        ...
        try {
            ...
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=io.horizontalsystems.indexwallet"))
